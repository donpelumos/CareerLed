...
/**
 * Created by BALE on 01/10/2015.
 */
public class DialogGroupOptions extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        list.add("Group Info");list.add("Leave Group");
        ...
        options.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    mListener.onSelected(DialogGroupOptions.this, "");
                } else if (position == 1) {
                    mListener.onSelected(DialogGroupOptions.this, "");
                }
            }

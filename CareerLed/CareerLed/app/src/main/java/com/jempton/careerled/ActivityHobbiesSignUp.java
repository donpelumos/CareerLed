...
public class ActivityHobbiesSignUp extends ActionBarActivity {
    LinearLayout ll;
    Button addButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hobbies_sign_up);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.getText().length() <= 1){
                    Toast.makeText(ActivityHobbiesSignUp.this, "Invalid Input", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    maxSlots = maxSlots - 1;
    ...
    public void onNextClicked(View view)
    {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                progress.dismiss();
                Intent toNextPage = new Intent(ActivityHobbiesSignUp.this, ActivityTalentsSignUp.class);
    ...
    public void onPreviousClicked(View view)
    {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                progress.dismiss();
                ActivityHobbiesSignUp.this.onBackPressed();
            }
        }, 1500);
    }

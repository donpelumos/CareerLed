...
/**
 * Created by BALE on 26/08/2015.
 */
public class ActivityInterestsSignUp extends ActionBarActivity {
    LinearLayout ll;
    Button addButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interests_signup);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input.getText().length() <= 1){
                    Toast.makeText(ActivityInterestsSignUp.this, "Invalid Input", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    maxSlots = maxSlots - 1;
    ...
    public void onNextClicked(View view)
    {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                progress.dismiss();
                Intent toNextPage = new Intent(ActivityInterestsSignUp.this, ActivityCertificationsSignUp.class);
    ...
    public void onPreviousClicked(View view)
    {
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                progress.dismiss();
                ActivityInterestsSignUp.this.onBackPressed();
            }
        }, 1500);
    }
